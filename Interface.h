...
enum Jobs {MANAGER, NAVIGATOR, FLIGHT_ATTENDANT, PILOT, OTHER};
...
public:
    ...
    Date(string date);    // The format of a date: YYYY-MM-DD.
...
public:
    ...
    virtual ~Airline_Data_Managment() {}
};
